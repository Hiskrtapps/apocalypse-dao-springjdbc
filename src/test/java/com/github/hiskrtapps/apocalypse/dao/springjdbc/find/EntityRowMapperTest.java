...
public class EntityRowMapperTest {
  ...
  public void testMapRow() throws SQLException {
    ...
    EntityRowMapper<TestCompleteMockEntity> entityRowMapper = new EntityRowMapper<>(TestCompleteMockEntity.class);

    TestCompleteMockEntity testCompleteMockEntity = entityRowMapper.mapRow(rs,0);
    Assert.assertNotNull(testCompleteMockEntity);
  }
